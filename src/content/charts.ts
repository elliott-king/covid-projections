...
export const SUMMARY_LEGEND_MEDIUM = 'Moderate risk based on reopening metrics.';
export const SUMMARY_LEGEND_HIGH = 'Elevated risk based on reopening metrics.';
export const SUMMARY_LEGEND_UNKNWON = 'We don’t have enough data to assess reopening risk.';
...
export const HOSPTIAL_USAGE_LEGEND_LOW = 'Can likely handle a new wave of COVID';
export const HOSPTIAL_USAGE_LEGEND_MEDIUM = 'At risk to a new wave of COVID';
export const HOSPTIAL_USAGE_LEGEND_HIGH = 'Unable to handle a new wave of COVID';
...
export const POSITIVE_TESTS_LEGEND_MEDIUM = 'Indicates testing is not widespread';
...
export const HOSPITAL_USAGE_LIMIT_LOW = .5;
export const HOSPITAL_USAGE_LIMIT_MEDIUM = .95;
export const HOSPITAL_USAGE_LIMIT_HIGH = Infinity;

// LIMITS -->  POSITIVE TESTS
export const POSITIVE_TESTS_LIMIT_LOW = .03;
export const POSITIVE_TESTS_LIMIT_MEDIUM = .1;
